🚀 Project Overview
NENE HELPER는 마인크래프트 자바 에디션 서버를 보다 빠르고 쉽게 구성하기 위해 만들어진 툴입니다.
PaperMC API를 통해 최신 서버 코어를 자동으로 가져오며, UI는 HTML/CSS 기반으로 직관적으로 구성되어 있습니다.

✔️ 원클릭 PaperMC 서버 생성

✔️ API 기반 최신 버전 자동 다운로드

✔️ 심플하고 가벼운 UI

✔️ Python 백엔드 + HTML 프론트엔드 구성
